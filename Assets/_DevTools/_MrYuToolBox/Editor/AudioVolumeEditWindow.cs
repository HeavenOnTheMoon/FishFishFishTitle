...
public class AudioVolumeEditWindow : EditorWindow
{
    ...
    Dictionary<string, CheepAnvil> UIAudioGroup;
    Dictionary<string, CheepAnvil> SceneAudioGroup;
    //序列化对象
    ...
    {
        UIAudioGroup = new Dictionary<string, CheepAnvil>();
        SceneAudioGroup = new Dictionary<string, CheepAnvil>();
        ...
        Dictionary<string, CheepAnvil> audioDic = new Dictionary<string, CheepAnvil>();
        if (FileInfo.Exists)
        {
        ...
        //UI
        foreach(object music in Enum.GetValues(typeof(ThereTern.UIMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            CheepAnvil model = new CheepAnvil();
        ...
        // Scene
        foreach (object music in Enum.GetValues(typeof(ThereTern.SceneMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            CheepAnvil model = new CheepAnvil();
    ...
    public Dictionary<string, CheepAnvil> LoadJson(string Filepath)
    {
        StreamReader reader = new StreamReader(Filepath);
        string jsonString = reader.ReadToEnd();
        Dictionary<string, CheepAnvil> audioGroup = JsonMapper.ToObject<Dictionary<string, CheepAnvil>>(jsonString);
        reader.Dispose();
        reader.Close();
        return audioGroup;
    }
    ...
    {
        Dictionary<string, CheepAnvil> dic = new Dictionary<string, CheepAnvil>();
        MergeDictionaries.Pulse(dic, UIAudioGroup);
        MergeDictionaries.Pulse(dic, SceneAudioGroup);
