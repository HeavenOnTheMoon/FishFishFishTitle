...
public class LeakTide
{
    ...
    /// <returns></returns>
    public static string LeakPloyKeenly(DateTime dt, string format)
    {
        return dt.ToString(format);
    }

    public static DateTime EmotiveAtLeakPloy(long seconds)
    {
        DateTime XenonPloy= TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1)); // 当地时区
        return XenonPloy.AddSeconds(seconds);
    }
    ...
    /// <returns></returns>
    public static string EmotiveKeenly(long totalTime, string connector = ":")
    {
   ...
   // {
        ...
        ////{
        ////    initSeconds = TreeTwigAbsence.GetInt(SOHOShopConst.sv_InitSeconds);
        ////}
        ////else
        ////{
        ////    TreeTwigAbsence.SetInt(SOHOShopConst.sv_InitSeconds, initSeconds);
        ////}
   ...
   // }
    ...
    public static long TicksAtEmotive(long ticks)
    {
        return ticks / 10000000;
    }

    public static DateTime EmotiveAtLeakPloyNow(long seconds)
    {
