...
/// 矩形遮罩镂空
/// </summary>
public class YardWeedyDown : MonoBehaviour
{
    public static YardWeedyDown instance;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    public void Dust(GameObject _target)
    {
        ...
        else
        {
            ...
            float width = 1;
            float height = 1;
            Lineage[0] = new Vector3(pos.x - width, pos.y - height);
            Lineage[1] = new Vector3(pos.x - width, pos.y + height);
            Lineage[2] = new Vector3(pos.x + width, pos.y + height);
            Lineage[3] = new Vector3(pos.x + width, pos.y - height);
        }
        //计算高亮显示区域在画布中的范围
