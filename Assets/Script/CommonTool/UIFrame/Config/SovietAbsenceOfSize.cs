...
public class SovietAbsenceOfSize : ISovietAbsence
{
    //保存键值对应用设置集合
    ...
    public SovietAbsenceOfSize(string jsonPath)
    {
    ...
    private void InitAndAnalysisJson(string jsonPath)
    {
        ...
        {
            throw new SizeContourEvaporate(GetType() + "/InitAndAnalysisJson()/Json Analysis Exception ! Parameter jsonPath=" + jsonPath);
        }
        //数据加载到AppSetting集合中
